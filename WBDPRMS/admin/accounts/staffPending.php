...
<head>
  ...
  <title>WBDPRMS - Account Management | Pending Staff Accounts</title>
        ...
        <div class="row">
          <div class="card table-with-links">
            <div class="card-header">
              <div>
                <h4 class="card-title float-start">Pending Staff Accounts</h4>
                <div class="float-end">
                  <a href="../../admin/accounts/staff.php" class="btn btn-info btn-round">Show Registered</a>
                </div>
              </div>
