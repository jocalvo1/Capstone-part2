...
<head>
    ...
    <title>WBDPRMS - Pending Appointments</title>
                ...
                <div class="row">
                    <div class="card table-with-links">
                        <div class="card-header">
                            <div>
                                <h4 class="card-title float-start">Pending Appointment Records</h4>
                                <div class="float-end">
                                    <a href="../../admin/appointment/index.php" class="btn btn-info btn-round">Show Appointments</a>
