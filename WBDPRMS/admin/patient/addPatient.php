...
<head>
  ...
  <title>WBDPRMS - Add Patient Record</title>
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="../../includes/admin/patientManagementController.php" method="post">
              <div class="row">
              ...
              <button type="submit" name="add_record" class="btn btn-primary btn-round float-start">Add Record</button>
              <div class="float-end">
