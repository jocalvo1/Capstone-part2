...
<head>
  ...
  <title>WBDPRMS - Account Management | Pending Patient Records</title>
        ...
        <div class="row">
          <div class="card table-with-links">
            <div class="card-header">
              <div>
                  <h4 class="card-title float-start">Pending Patient Records</h4>
                  <div class="float-end">
                      <a href="../../admin/patient/index.php" class="btn btn-info btn-round">Show Patient Records</a>
                      <button class="btn btn-warning btn-round"><i class="fa fa-print"></i></button>
                      <a href="../../admin/patient/addPatient.php" class="btn btn-icon btn-round"><i class="fa fa-plus"></i></a>
                  </div>
              </div>
